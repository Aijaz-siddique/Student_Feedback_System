...
<title>View Transport Feedback</title>
...
$sql = "SELECT * FROM transportfeedback";
$result = $conn->query($sql);
	...
	if ($result->num_rows > 0) {
		...
		//while($row = $result->fetch_assoc()) {
			$i = 1;
			echo "<table align='center' border=2px><tr bgcolor='aqua'><th>SNo</th><th width='300px'>Feedback</th></tr>";
				// output data of each row
				while($row = $result->fetch_assoc()) {
					echo "<tr align='center' bgcolor='white'><td>".$i."</td><td width='300px'>" . $row["feedback"]. "</td></tr>";
					$i++;
				}
				echo "</table>";
	} else {
