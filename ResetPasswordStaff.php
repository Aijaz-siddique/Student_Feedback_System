<?php
	...
	if(isset($_POST['submit'])){
		  ...
		  if($db){
				...
				$query="update stafflogin set StaffPassword='$studentpassword' where UserId=$registrationno ";
        ...
        <div class="jumbotron text-center">
			<div class="container">
					...
					<form class="form-horizontal" action="#" method="post" name="r1">
						...
						<div class="col-sm-5">          
						  <input type="text" class="form-control" name="userid" placeholder="Enter the User Id." required>
						</div>
					   </div>
