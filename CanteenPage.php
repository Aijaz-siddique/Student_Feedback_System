<?php
	...
	if(isset($_POST['submit'])){
		  ...
		  if($db){
				...
				$query="insert into canteenfeedback(Feedback,breakfast,lunch,dinner) values('$feedback','$breakfast','$lunch','$dinner')";
    ...
    <div class="container">
        <div class="jumbotron text-center">
			...
			<div class="container">
							...
							<div class="text-center">
								<label class="control-label col-sm-1" > Lunch:</label>
								<div class="col-sm-1">
									<select name="lunch">
										<option value="1">1</option>
										<option value="2">2</option>
							...
							<div class="text-center">
								<label class="control-label col-sm-1" > Dinner:</label>
								<div class="col-sm-1">
									<select name="dinner">
										<option value="1">1</option>
										<option value="2">2</option>
