<?php
	...
	if(isset($_POST['submit'])){
		  ...
		  $interaction = $_POST['interaction_with_class'];
		  $example = $_POST['explanation_with_example'];
		  $doubt = $_POST['doubt_clearence'];
		  $dbhost = "localhost";
		  $dbuser = "root";
		  $dbpass = "barsa";
		  $db = "feedbacksystem";
		  ...
		  if($db){
				...
				$query="insert into facultyfeedback(Feedback,interaction,example,doubt) values('$feedback','$interaction','$example','$doubt')";
    ...
    <nav class="navbar navbar-default">
        ...
        <div class="container">
            ...
            <div class="navbar-collapse collapse">
				...
				<!-- logout button -->
                    <li class="active"><a href="Student.php"> <button type="button" class="btn btn-info btn-lg" data-toggle="modal" data-target="#myModal">Logout</button></a></li> 
				<!-- logout button End here -->
				
				<!-- change password button -->
                    <li class="active"><a href="ResetPasswordStudent.php"> <button type="button" class="btn btn-info btn-lg" data-toggle="modal" data-target="#myModal">Reset Password</button></a></li> 
...
<br/>
     <div class="container">
        <div class="jumbotron text-center">
			<div class="container">
					...
					<form class="form-horizontal" action="#" method="post" name="r1">
						  ...
						  <div class="text-center" >
								<label class="control-label col-sm-3" >Your Feedback:</label>
								<div class="col-sm-4"> 
			 ...
			 <div class="container">
							<div class="text-center">
								<label class="control-label col-sm-4" > Interaction with class:</label>
								<div class="col-sm-1">
			...
			<div class="container">
							<div class="text-center">
								<label class="control-label col-sm-4" > Explanation with examples:</label>
								<div class="col-sm-1">
			...
			<div class="container">
							<div class="text-center">
								<label class="control-label col-sm-4" > Doubt clearence:</label>
								<div class="col-sm-1">
