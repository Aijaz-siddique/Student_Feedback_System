<?php
	...
	if(isset($_POST['submit'])){
		  ...
		  if($db){
				...
				$query="update studentlogin set StudentPassword='$studentpassword' where RegistrationNo=$registrationno ";
				//UPDATE studentlogin set StudentPassword='your password' where RegistrationNo=1401227211;
				...
				echo "<script> alert('Something went wrong\n please try again'); window.location.href='';</script>";
			}
        }
        ...
        <div class="jumbotron text-center">
			<div class="container">
					...
					<form class="form-horizontal" action="#" method="post" name="r1">
						...
						<div class="col-sm-5">          
						  <input type="text" class="form-control" name="regno" placeholder="Enter Student Registration No." required>
						</div>
					   </div>
