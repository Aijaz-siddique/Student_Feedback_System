...
<?php
        ...
        if(isset($_POST['submit'])){
		  ...
		  if(isset($_POST['regno'])){
				...
				$query="select * from studentlogin where RegistrationNo = '".$registrationno."' AND StudentPassword = '".$password."' limit 1";
    ...
    <div class="container">
        <div class="jumbotron text-center">
			<div class="container">
					...
					<form class="form-horizontal" action="Student.php" method="post" name="r1">
					
						  <div class="form-group">
								<label class="control-label col-sm-5" >Registration No:</label>
								<div class="col-sm-4">          
								  <input type="text" class="form-control" name="regno" placeholder="Enter the registrationNo" required>
								</div>
						   </div>
